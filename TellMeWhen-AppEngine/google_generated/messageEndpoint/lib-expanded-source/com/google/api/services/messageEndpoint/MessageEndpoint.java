 ...
 * on 2013-06-23 at 08:04:45 UTC 
 * Modify at your own risk.
 */

package com.google.api.services.messageEndpoint;
...
public class MessageEndpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * An accessor for creating requests from the MessageEndpointOperations collection.
   *
   * <p>The typical use is:</p>
   * <pre>
   *   {@code MessageEndpoint messageEndpoint = new MessageEndpoint(...);}
   *   {@code MessageEndpoint.MessageEndpointOperations.List request = messageEndpoint.messageEndpoint().list(parameters ...)}
   * </pre>
   *
   * @return the resource collection
   */
  public MessageEndpointOperations messageEndpoint() {
    return new MessageEndpointOperations();
  }

  /**
   * The "messageEndpoint" collection of methods.
   */
  public class MessageEndpointOperations {

    /**
     * Create a request for the method "messageEndpoint.sendMessage".
     *
